...
### I can train medical ML models better, then others.
Thanks to my medical, scientific, and ML skills, I understand not just "how to" train an ML model, but also "why I train a model in such a way". I can explain the "black box" using my scientific and medical knowledge.
